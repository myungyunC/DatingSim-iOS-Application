...
class Day2SchoolHallwaySceneBad: SKScene {
    ...
    let sofiaMad = SKSpriteNode(imageNamed: "SofiaMad.png")          //The girl's blush picture
    ...
    func createButtons(option1: NSString, option2: NSString, option3: NSString) {
        ...
        firstOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day2SchoolHallwaySceneBad.firstButtonTap))
        ...
        secondOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day2SchoolHallwaySceneBad.secondButtonTap))
        ...
        thirdOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day2SchoolHallwaySceneBad.thirdButtonTap))
    ...
    override func didMove(to view: SKView) {
        ...
        let action = SKAction.run{
            ...
            self.addTextLabel(labelIn: "You decided that at this point")
            dialogue += 1
        }
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                if (pauseBool){
                    ...
                    case(dialogue == 2) :
                        ...
                        addTextLabel(labelIn: "...you've had enough of the prez.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 3) :
                        addTextLabel(labelIn: "You also realize its lunch time.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 4) :
                        addTextLabel(labelIn: "You decide to eat lunch on the roof")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 5) :
                        addTextLabel(labelIn: "to make sure you don't see her again...")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 6) :
                        let x = Day2RooftopBad(size: self.size)
                        changeScene(nextScene: x)
                        break;
