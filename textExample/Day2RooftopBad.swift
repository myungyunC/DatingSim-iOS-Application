...
class Day2RooftopBad: SKScene {
    ...
    func removeCharacter(movingCharacter: SKSpriteNode) {                                 //removes a character from the middle from the left.
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                if (pauseBool){
                    ...
                    case(dialogue == 7) :
                        ...
                        addTextLabel(labelIn: "\"Are you serious??\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 8) :
                        addTextLabel(labelIn: "\"Is that actually you?\"")
                        dialogue += 1
                        break;
                        
                    case dialogue == 9:
                        addTextLabel(labelIn: "\"Screw this, I'm leaving...\"")
                        dialogue += 1
                        break
                        
                    case dialogue == 10:
                        changeTextBackground(changedBackground: mainTextBackground)
                        addTextLabel(labelIn: "Before she leaves, you realize..")
                        dialogue += 1
                        break
                        
                    case dialogue == 11:
                        addTextLabel(labelIn: "..she's way more upset than you.")
                        dialogue += 1
                        break
                        
                    case dialogue == 12:
                        addTextLabel(labelIn: "You decide to swalloy your pride")
                        dialogue += 1
                        break
                        
                    case dialogue == 13:
                        addTextLabel(labelIn: "and apologize for ignoring her")
                        dialogue += 1
                        break
                        
                    case dialogue == 14:
                        changeTextBackground(changedBackground: girlTextBackground)
                        addTextLabel(labelIn: "\"You're so lazy, and really mean..\"")
                        dialogue += 1
                        break
                        
                    case dialogue == 15:
                        addTextLabel(labelIn: "\"..you know that?\"")
                        dialogue += 1
                        break
                        
                    case dialogue == 16:
                        addTextLabel(labelIn: "\"You show up late and ignore me!\"")
                        dialogue += 1
                        break
                        
                    case dialogue == 17:
                        addTextLabel(labelIn: "\"That's it...\"")
                        dialogue += 1
                        break
                        
                    case dialogue == 18:
                        addTextLabel(labelIn: "\"...I'm going to whip you into shape!\"")
                        dialogue += 1
                        break
