...
class Final_FullWin: SKScene {
    ...
    func createButtons(option1: NSString, option2: NSString, option3: NSString) {
        ...
        firstOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Final_FullWin.firstButtonTap))
        ...
        secondOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Final_FullWin.secondButtonTap))
        ...
        thirdOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Final_FullWin.thirdButtonTap))
    ...
    override func didMove(to view: SKView) {
        ...
        let action = SKAction.run{
            ...
            self.addTextLabel(labelIn: "\"This... this can't be!\"")
            dialogue += 1
        }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch: AnyObject in touches {
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                case(dialogue == 2) :
                    addTextLabel(labelIn: "\"I've been defeated by a mere kid...\"")
                    dialogue += 1
                    break;
                    
                case(dialogue == 3) :
                    addTextLabel(labelIn: "\"I must be running low on chakra.\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 4) :
                    ...
                    addTextLabel(labelIn: "\"Dad.... Stop.\"")
                    dialogue += 1
                    break;
                    
                case(dialogue == 5) :
                    changePicture(changedPicture: militaryDadSmall)
                    changeTextBackground(changedBackground: dadTextBackground)
                    addTextLabel(labelIn: "\"Alright, alright. Kid. I'll see you.\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 6) :
                    ...
                    addTextLabel(labelIn: "So, Ulysses left.")
                    dialogue += 1
                    break;
                    
                case(dialogue == 7) :
                    addTextLabel(labelIn: "I wouldn't see much of him from then on.")
                    dialogue += 1
                    break;
                    
                case(dialogue == 8) :
                    moveCharacter(movingCharacter: sofiaCasualBlush)
                    changeTextBackground(changedBackground: girlTextBackground)
                    addTextLabel(labelIn: "\"I'm so sorry about that!\"")
                    dialogue += 1
                    break;
                    
                case dialogue == 9:
                    changePicture(changedPicture: sofiaMad)
                    addTextLabel(labelIn: "\"I wasn't allowed to tell you about...\"")
                    dialogue += 1
                    break
                    
                case dialogue == 10:
                    addTextLabel(labelIn: "\"his surprise test for you.\"")
                    dialogue += 1
                    break
                    
                case dialogue == 11:
                    changePicture(changedPicture: sofiaCasualHappy)
                    addTextLabel(labelIn: "\"But wow, you blew me away!\"")
                    dialogue += 1
                    break
                    
                case dialogue == 12:
                    changePicture(changedPicture: sofiaCuteBlush)
                    addTextLabel(labelIn: "\"And that's exactly why I love you. \"")
                    dialogue += 1
                    break
                    
                case dialogue == 13:
                    changePicture(changedPicture: sofiaCasualBlush)
                    addTextLabel(labelIn: "\"So because you got the approval of my dad...\"")
                    dialogue += 1
                    break
                    
                case dialogue == 14:
                    addTextLabel(labelIn: "\"We can date now!\"")
                    dialogue += 1
                    break
                    
                case dialogue == 15:
                    addTextLabel(labelIn: "\"So, what do you say?\"")
                    createButtons(option1: "Lean in for the kiss*", option2: "\"Aight, call me babe now.\"", option3: "\"Sorry, I don't actually like you.\"")
                    break
                    
                case dialogue == 16:
                    changeTextBackground(changedBackground: girlTextBackground)
                    addTextLabel(labelIn: "\"Wha... Not so fast there!\"")
                    dialogue += 3
                    break
                    
                case dialogue == 17:
                    changeTextBackground(changedBackground: girlTextBackground)
                    addTextLabel(labelIn: "\"Don't push it, lol.\"")
                    dialogue += 2
                    break
                    
                case dialogue == 18:
                    changeTextBackground(changedBackground: girlTextBackground)
                    addTextLabel(labelIn: "...")
                    dialogue += 9
                    break
                ...
                case dialogue == 19:
                    ...
                    addTextLabel(labelIn: "And so, my chapter with Sofia comes to a close.")
                    choice = 0
                    dialogue += 1
                    break
                    
                case dialogue == 20:
                    addTextLabel(labelIn: "I left her home and saw her the next day.")
                    dialogue += 1
                    break
                    
                case dialogue == 21:
                    addTextLabel(labelIn: "...and everyday after that.")
                    dialogue += 1
                    break
                    
                case dialogue == 22:
                    addTextLabel(labelIn: "We had a very happy life together.")
                    dialogue += 1
                    break
                    
                case dialogue == 23:
                    addTextLabel(labelIn: "We got married after college and had 5 kids.")
                    dialogue += 1
                    break
                    
                case dialogue == 24:
                    addTextLabel(labelIn: "They would later go on to make this game about us.")
                    dialogue += 1
                    break
                    
                case dialogue == 25:
                    addTextLabel(labelIn: "The End!")
                    dialogue += 1
                    break
                ...
                case dialogue == 31:
                    ...
                    moveCharacter(movingCharacter: militaryDad)
                    addTextLabel(labelIn: " ")
                    dialogue += 1
                    break
