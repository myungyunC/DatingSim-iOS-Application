...
class pre_boss_L2: SKScene, SKPhysicsContactDelegate {
//    gameScore = 0
//    enemyRegion = 0
//    spawnStartOfGame = true
//    
//    pauseButton = SKSpriteNode(imageNamed: "pausebutton")
//    pauseBackground = SKSpriteNode(imageNamed: "white")
//    inPauseButton = SKSpriteNode(imageNamed: "pauseButt")
//    pauseBool = false
    ...
    func changeScene(){
        ...
        let sceneToMoveTo = game_boss_L2(size: self.size)
        sceneToMoveTo.scaleMode = self.scaleMode
