...
class Day2WinScene: SKScene {
    ...
    func createButtons(option1: NSString, option2: NSString, option3: NSString) {
        ...
        firstOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day2WinScene.firstButtonTap))
        ...
        secondOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day2WinScene.secondButtonTap))
        ...
        thirdOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day2WinScene.thirdButtonTap))
    ...
    override func didMove(to view: SKView) {
        ...
        self.moveCharacter(movingCharacter: self.sofiaCasualBlush)
        
        let wait = SKAction.wait(forDuration: 0.5)
        let action = SKAction.run{
            self.changeTextBackground(changedBackground: self.girlTextBackground)
            self.addTextLabel(labelIn: "\"Wow. You're amazing!\"")
            dialogue += 1
        }
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                if (pauseBool){
                    ...
                    case(dialogue == 2) :
                        ...
                        addTextLabel(labelIn: "\"We should really keep in touch somehow.\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 3) :
                        addTextLabel(labelIn: "\"Give me your number!\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 4) :
                        addTextLabel(labelIn: "\"Don't worry, I don't bite. haha\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 5) :
                        changeTextBackground(changedBackground: mainTextBackground)
                        addTextLabel(labelIn: "You proceed to give her your number.")
                        dialogue += 1
                        break;
                    ...
                    case(dialogue == 6) :
                        ...
                        addTextLabel(labelIn: "\"Thanks! Okay, I'll smell ya later!\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 7) :
                        changeTextBackground(changedBackground: mainTextBackground)
                        removeCharacter(movingCharacter: sofiaConfidentBlush)
                        addTextLabel(labelIn: "She runs to the door and down the stairs.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 8) :
                        addTextLabel(labelIn: "She ain't half bad though. Not at all.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 9) :
                        addTextLabel(labelIn: "Wow, a girl has your number for once.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 10) :
                        addTextLabel(labelIn: "You're actually not a complete loser.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 11) :
                        addTextLabel(labelIn: "Hopefully she won't notice that...")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 12) :
                        addTextLabel(labelIn: "I have a flip-phone.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 13) :
                        
                        addTextLabel(labelIn: "THAT would be embarassing.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 14) :
                        addTextLabel(labelIn: "Like who even has those anymore, kek.")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 15) :
                        addTextLabel(labelIn: "The rest of the day proceeds as normal.")
                        dialogue += 1
                        break;
