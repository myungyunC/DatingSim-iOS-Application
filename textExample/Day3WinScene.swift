...
class Day3WinScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let action = SKAction.run{
            ...
            self.addTextLabel(labelIn: "\"Wow... You're something else!\"")
            dialogue += 1
        }
        ...
        for touch: AnyObject in touches {
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                case(dialogue == 2) :
                    ...
                    addTextLabel(labelIn: "\"That was really fun!\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 11) :
                    changeTextBackground(changedBackground: girlTextBackground)
                    changePicture(changedPicture: sofiaCasualHappy)
                    addTextLabel(labelIn: "\"Well, I guess this is bye then.\"")
                    dialogue += 1
                    break;
                    
                case(dialogue == 12) :
                    changeTextBackground(changedBackground: mainTextBackground)
                    addTextLabel(labelIn: "\"Actually, why don't I walk you home?\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 13) :
                    changeTextBackground(changedBackground: girlTextBackground)
                    changePicture(changedPicture: sofiaCasualBlush)
                    addTextLabel(labelIn: "\"Oh really? I would love that!\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 15) :
                    addTextLabel(labelIn: "the direction she came from earlier.")
                    dialogue += 1
                    break;
                    
                case(dialogue == 16) :
                    addTextLabel(labelIn: "Somehow 7 hours passed by. Night approaches.")
                    dialogue += 1
                    break;
