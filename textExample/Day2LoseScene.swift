...
class Day2LoseScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        let action = SKAction.run{
            ...
            self.addTextLabel(labelIn: "\"Well. That was underwhelming.\"")
            dialogue += 1
        }
        ...
        for touch: AnyObject in touches {
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                if (pauseBool){
                    ...
                    case(dialogue == 2) :
                        addTextLabel(labelIn: "\"Sigh. Men these days.\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 3) :
                        addTextLabel(labelIn: "\"They can never last long enough.\"")
                        dialogue += 1
                        break;
                        
                    case(dialogue == 4) :
                        changePicture(changedPicture: sofiaConfidentNervous)
                        addTextLabel(labelIn: "\"Even so! I want to keep in touch.\"")
                        dialogue += 1
                        break;
