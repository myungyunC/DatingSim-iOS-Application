...
class Day4FrontDoor: SKScene {
    ...
    func createButtons(option1: NSString, option2: NSString, option3: NSString) {
        ...
        firstOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day4FrontDoor.firstButtonTap))
        ...
        secondOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day4FrontDoor.secondButtonTap))
        ...
        thirdOption.setButtonAction(target: self, triggerEvent: .TouchUpInside, action: #selector(Day4FrontDoor.thirdButtonTap))
    ...
    override func didMove(to view: SKView) {
        ...
        let action = SKAction.run{
            ...
            self.addTextLabel(labelIn: "You stepped through the front door.")
            dialogue += 1
        }
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        for touch: AnyObject in touches {
            ...
            if pauseButton.contains(pointOfTouch){
                ...
                case(dialogue == 2) :
                    addTextLabel(labelIn: "\"Hello...? Is anyone home?\"")
                    dialogue += 1
                    break;
                    
                case(dialogue == 3) :
                    changeTextBackground(changedBackground: dadTextBackground)
                    addTextLabel(labelIn: "\"WHO GOES THERE SOLDIER?!?\"")
                    dialogue += 1
                    break;
                    
                case(dialogue == 4) :
                    changeTextBackground(changedBackground: girlTextBackground)
                    addTextLabel(labelIn: "\"Dad! Wait!\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 5) :
                    ...
                    addTextLabel(labelIn: "\"Who is this pipsqueak of a man?\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 6) :
                    ...
                    changeTextBackground(changedBackground: girlTextBackground)
                    addTextLabel(labelIn: "\"He's the boy I've been talking about!\"")
                    dialogue += 1
                    break;
                    
                case(dialogue == 7) :
                    changePicture(changedPicture: sofiaMad)
                    addTextLabel(labelIn: "\"I told you to keep your voice down Dad!\"")
                    dialogue += 1
                    break;
                ...
                case(dialogue == 8) :
                    ...
                    changeTextBackground(changedBackground: dadTextBackground)
                    addTextLabel(labelIn: "\"Kid. You are small and weak and smelly.\"")
                    createButtons(option1: "\"I tried to tell her, but she insisted on me.\"", option2: "\"Did you hurt your eye from the solar eclipse?\"", option3: "\"Kid. You are small and weak and smelly.\"")
                    break;
                    
                case dialogue == 9:
                    changeTextBackground(changedBackground: dadTextBackground)
                    addTextLabel(labelIn: "\"Are you blaming it on MY DAUGHTER?!?\"")
                    dialogue += 3
                    break
                    
                case dialogue == 10:
                    changeTextBackground(changedBackground: dadTextBackground)
                    addTextLabel(labelIn: "\"Do you think you're funny? Funny boy?\"")
                    dialogue += 2
                    break
                    
                case dialogue == 11:
                    changeTextBackground(changedBackground: dadTextBackground)
                    addTextLabel(labelIn: "If you insist on playing games, look no further.")
                    dialogue += 1
                    break
                    
                case dialogue == 12:
                    addTextLabel(labelIn: "If you think you are worthy for my daughter...")
                    choice = 0
                    dialogue += 1
                    break
                    
                case dialogue == 13:
                    addTextLabel(labelIn: "Then, PREPARE YOURSELF.")
                    dialogue += 1
                    break
                    
                case dialogue == 14:
                    addTextLabel(labelIn: "\"FACE ME AS A MAN.\"")
                    dialogue += 1
                    break
                    
                case dialogue == 15:
                    let x = game_boss_L3(size: self.size)
                    changeScene(nextScene: x)
                    break
